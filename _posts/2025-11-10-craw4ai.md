...
**Key Results:**
- ⚡ **14 seconds per enrichment** (vs 10 minutes manual)
- 🎯 **4-6 fields auto-populated** from company websites
- ✅ **Zero custom fields** (100% standard ERPNext)
- 📊 **97% time savings** (3+ hours/week recovered)
- 🚀 **Production-ready** (80%+ test coverage)
- 🔓 **Open source** (MIT license)

[Video Tutorial](#) | [GitHub Repository](https://github.com/noreli/web_data_enrichment) | [Blog](https://norelinorth.github.io)
...
- Python 3.10+
- [AI Assistant app](https://frappecloud.com/marketplace/apps/ai_assistant) installed
...
- **📖 README**: [Full user guide](https://github.com/noreli/web_data_enrichment/blob/main/README.md)
- **📖 Installation Guide**: [Step-by-step setup](https://github.com/noreli/web_data_enrichment/blob/main/INSTALLATION.md)
- **📖 Architecture**: [Technical deep-dive](https://github.com/noreli/web_data_enrichment/blob/main/ARCHITECTURE.md)
- **📖 Changelog**: [Version history](https://github.com/noreli/web_data_enrichment/blob/main/CHANGELOG.md)

### Links

- **🎥 Video Tutorial**: [YouTube](#) ← Coming soon
- **💻 GitHub Repository**: [noreli/web_data_enrichment](https://github.com/noreli/web_data_enrichment)
- **📝 Blog**: [norelinorth.github.io](https://norelinorth.github.io)
- **💬 Discussions**: [GitHub Discussions](https://github.com/noreli/web_data_enrichment/discussions)
- **🐛 Issues**: [GitHub Issues](https://github.com/noreli/web_data_enrichment/issues)

### Related Projects

- **crawl4ai**: [GitHub](https://github.com/unclecode/crawl4ai) - The open-source web scraper powering Stage 1
- **ERPNext AI Assistant**: [Marketplace](https://frappecloud.com/marketplace/apps/ai_assistant) - Required for LLM integration
- **Frappe Framework**: [docs.frappe.io](https://docs.frappe.io) - The framework powering ERPNext
...
[Open an issue](https://github.com/noreli/web_data_enrichment/issues) with:
- Steps to reproduce
- Expected behavior
- Actual behavior
- ERPNext version
...
[Start a discussion](https://github.com/noreli/web_data_enrichment/discussions) with:
...
3. Make your changes
4. Write tests (we maintain 80%+ coverage)
5. Ensure tests pass (`bench run-tests --app web_data_enrichment`)
...
**GitHub**: [https://github.com/noreli/web_data_enrichment](https://github.com/noreli/web_data_enrichment)
...
**Author**: Noreli North
**GitHub**: [@noreli](https://github.com/noreli)
**License**: MIT
