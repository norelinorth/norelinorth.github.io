...
A: Yes! Set the Langfuse Host to your self-hosted URL.

**Q: What data does the AI actually see?**
A: Transaction patterns (count, volume), new parties, voucher distributions, and sample transaction descriptions. All queried from your actual GL Entries.

**Q: How much does it cost?**
A: ~$0.01-$0.02 per explanation with GPT-4-turbo. Much cheaper with GPT-3.5-turbo or local models.

**Q: Is this auditor-friendly?**
A: YES. Full audit trail with WHO created it, WHEN, WHAT they said, and HOW it was categorized. Plus Langfuse traces showing the complete AI reasoning process.

**Q: Can I update explanations?**
A: Yes! Override capability lets you regenerate while preserving the modification history.
